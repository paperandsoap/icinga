...
default['icinga']['setup']['package_dependencies'] = %w(xinetd python php5-curl)
default['icinga']['setup']['packages'] = %w(icinga icinga-cgi icinga-core)
default['icinga']['setup']['nagios_dir'] = '/usr/lib/nagios'
